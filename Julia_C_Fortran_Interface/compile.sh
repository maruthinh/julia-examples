...
gfortran -c main.f90 
gfortran main.o mod_call_my_sqrt_func_from_julia_in_fortran_via_c.o call_my_sqrt_func_from_julia_in_c.o -o test -L$JULIA_DIR/lib -Wl,-rpath,$JULIA_DIR/lib -ljulia
./test
